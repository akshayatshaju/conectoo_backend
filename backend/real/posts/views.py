...
class NotificationPostDetailView(generics.RetrieveAPIView):
    permission_classes = [IsAuthenticated]
    ...
    def get(self, request, *args, **kwargs):
        try:
            ...
            if notification.post:
                ...
                return Response({'error': 'No post associated with this notification'}, status=status.HTTP_404_NOT_FOUND)
